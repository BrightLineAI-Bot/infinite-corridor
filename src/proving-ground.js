...
import { render, renderScaleForViewport } from "./renderer.js?v=90";
import { LABORATORIES, DEFAULT_PROVING_SEED, scenariosForLab, createLabFixture, labReport, teleportTargets } from "./proving-ground-labs.js?v=90";
